...
{ 
    ...
    { 
        //Its task is to clear screen with default value after a certain time 
        //(normally, after 1/30 sec or 1/60 sec). So, if any change of coordinate happens, 
        //then it will appear to be moving as human eye can distinguish image only 
        //which is separated by 1/16 second (persistence of vision).
