...
{ 
    ...
    { 
        ...
        { 
            ...
            // glVertex2i(x / 4 - 300 * cos(j), y / 4 - 50 * sin(j)); 
            glVertex2i((x / 4 - 600 * cos(j))-300*cos(2*j), (y / 4 - 100 * sin(j))-50*sin(2*j));
        } 
        ...
        { 
            ...
            glVertex2i(- 600 * cos(j)-300*cos(2*j), i  / 4 - 100 * sin(j)-50*sin(2*j)); 
        } 
